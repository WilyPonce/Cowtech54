...
public class DynamicXYPlotA2 extends Activity {
    ...
    public DynamicXYPlotA2() {
        ...
        DynamicSeries sine1Series = new DynamicSeries(data, 0, "Sine 1");
        DynamicSeries sine2Series = new DynamicSeries(data, 1, "Sine 2");
