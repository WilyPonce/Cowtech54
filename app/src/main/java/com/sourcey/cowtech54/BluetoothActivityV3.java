...
public class BluetoothActivityV3 extends AppCompatActivity {
    ...
    private void updatePlot(){
        ...
        try {
            ...
            LinkedList<Number> t1 = btMessageManager.MatIDs.get(selecIDInt).getTime();

            LinkedList<Number> v1 = btMessageManager.MatIDs.get(selecIDInt).getByte1();
            LinkedList<Number> v2 = btMessageManager.MatIDs.get(selecIDInt).getByte2();
            LinkedList<Number> v3 = btMessageManager.MatIDs.get(selecIDInt).getByte3();
            LinkedList<Number> v4 = btMessageManager.MatIDs.get(selecIDInt).getByte4();
            LinkedList<Number> v5 = btMessageManager.MatIDs.get(selecIDInt).getByte5();
            LinkedList<Number> v6 = btMessageManager.MatIDs.get(selecIDInt).getByte6();
            LinkedList<Number> v7 = btMessageManager.MatIDs.get(selecIDInt).getByte7();
            LinkedList<Number> v8 = btMessageManager.MatIDs.get(selecIDInt).getByte8();
